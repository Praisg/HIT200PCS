<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/hit.png" width="150" height="80" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="agent.php">Property Owner</a> </li>
                                    ...
                                    <a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php" onclick="return submitProperty() ">Submit Property</a> 
                                    
<script>
    function submitProperty() {
        // Check user type and allow/deny access
        var userType = "<?php echo $utype; ?>"; // Assuming $utype contains the user type
