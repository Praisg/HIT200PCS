						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="useragent.php"> Properrty Owners </a></li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>University</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="stateadd.php">Harare Institute Of Technology</a></li>
								</ul>
							</li>
						
							<li class="menu-title"> 
								<span>Issuing Verification</span>
							</li>
							<li class="submenu">
								<a href="#"><i class="fe fe-map"></i> <span> Verification</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
