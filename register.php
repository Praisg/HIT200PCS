                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-check-inline">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="utype" value="agent">Property Owner
										</label>
									</div>
									...
									<div class="form-group">
										<input type="text" name="email" id="email" class="form-control" placeholder="Your Email*" pattern="^h\d+[a-z]@hit\.ac\.zw$">
									...
									<div class="form-group">
										...
										<small class="form-text text-muted">Use your Student-ID.</small>
									</div>
									<div></div>
    ...
    window.onload = function() {
        ...
        userTypeRadios.forEach(radio => {
            radio.addEventListener('change', () => {
                if (radio.value === 'user') {
                    emailInput.setAttribute('pattern', '^h\\d+[a-z]@hit\\.ac\\.zw$');
                    document.getElementById('emailHelp').textContent = 'Use your HIT email.';
                } else {
